...
$_lang['sendex_users'] = 'Список подписчиков';
$_lang['sendex_user_intro'] = 'Здесь вы можете посмотреть информацию о подписчиках';
$_lang['sendex_user_id'] = 'ID';
$_lang['sendex_user_email'] = 'Электронная почта';
$_lang['sendex_user_group'] = 'Группа пользователя';
$_lang['sendex_user_status'] = 'Статус';
$_lang['sendex_user_btn_create'] = 'Добавить пользователя';
$_lang['sendex_import_user_btn_create'] = 'Импорт пользователей';

$_lang['sendex_user_create'] = 'Добавить пользователя';

$_lang['sendex_user_import_file'] = 'Загрузить файл с базой данных';




$_lang['sendex_users_group'] = 'Список групп подписчиков';
$_lang['sendex_user_group_intro'] = 'Здесь вы можете добавить группы подписчиков';
$_lang['sendex_user_group_id'] = 'ID';
$_lang['sendex_user_group_name'] = 'Название группы';
$_lang['sendex_user_group_description'] = 'Описание группы';
